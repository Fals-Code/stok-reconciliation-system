...
declare
  ...
  v_rule_set_version constant text := 'core-integrity-v7';
...
begin
  ...
  loop
    ...
    if v_check_code = 'LEDGER_BATCH_PROJECTION' then
      ...
      'RETURN_RECEIPT_QUARANTINE' then
      ...
      loop
        ...
        values (
          ...
          v_run_check_id,
          1,
          'RETURN_RECEIPT_QUARANTINE_MISMATCH',
          'RETURN',
          jsonb_build_object(
            'eventId',
            v_mismatch.event_id,
      ...
      'RETURN_INSPECTION_TRANSFER' then
      ...
      loop
        ...
        values (
          ...
          v_run_check_id,
          1,
          'RETURN_INSPECTION_TRANSFER_MISMATCH',
          'RETURN',
          jsonb_build_object(
            'inspectionId',
            v_mismatch.inspection_id,
