...
-- Repair Product SKU automation contract for databases that already applied the earlier 20260811000000 definition.
-- Replays the final generator, snapshot/read model, Product RPCs, legacy overload retirement, and privileges without changing stock data.
