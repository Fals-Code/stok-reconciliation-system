...
export function ApprovalPanel({ lines, stocktakeId, stocktakeVersion }: { lines: StocktakeReviewLine[]; stocktakeId: string; stocktakeVersion: number }) {
